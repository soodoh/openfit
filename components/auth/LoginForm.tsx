...
import { signIn, signUp } from "@/components/providers/AuthProvider";
...
const OAUTH_PROVIDERS = [
  ...
  },
  {
    id: "discord",
    name: "Discord",
    enabled: !!process.env.NEXT_PUBLIC_AUTH_DISCORD_ENABLED,
  },
  {
    id: "oidc",
    name: process.env.NEXT_PUBLIC_AUTH_OIDC_PROVIDER_NAME || "SSO",
    enabled: !!process.env.NEXT_PUBLIC_AUTH_OIDC_ENABLED,
  },
].filter((p) => p.enabled);
