...
e2eTest.describe("Dashboard", () => {
  ...
  e2eTest(
    "should navigate to routines page from quick access",
  ...
  e2eTest(
    "should navigate to exercises page from quick access",
    async ({ dashboardPage, page }) => {
      await dashboardPage.waitForConvexData();
  ...
  e2eTest(
    "should navigate to logs page from quick access",
    async ({ dashboardPage, page }) => {
      await dashboardPage.waitForConvexData();
      // Click logs card
      const logsLink = page
  ...
  e2eTest(
    "should open new session modal when clicking new session button",
    async ({ dashboardPage, page }) => {
      await dashboardPage.waitForConvexData();
  ...
  e2eTest(
    "should show empty state or recent sessions",
    async ({ dashboardPage, page }) => {
      await dashboardPage.waitForConvexData();
  ...
  e2eTest(
    "should navigate to logs when clicking view all",
    async ({ dashboardPage, page }) => {
      await dashboardPage.waitForConvexData();
