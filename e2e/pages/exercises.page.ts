...
export class ExercisesPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.pageSubtext = page.getByText(/browse and discover exercises for your workouts/i);
     ...
     */
    async selectFilter(filterType: "equipment" | "level" | "category" | "muscle", value: string): Promise<void> {
        let trigger: Locator;
     ...
     */
    async getResultsNumber(): Promise<number | undefined> {
