...
export class RoutinesPage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.pageSubtext = page.getByText(/manage your workout routines and training schedules/i);
    ...
    async isCreateRoutineModalOpen(): Promise<boolean> {
        return this.isVisible(this.page.getByRole("dialog").filter({ hasText: /routine/i }));
    }
    /**
