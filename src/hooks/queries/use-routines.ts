...
async function fetchRoutines(filters: RoutineFilters = {}, cursor?: string, limit = 20, signal?: AbortSignal): Promise<PaginatedResponse<Routine>> {
...
export function useRoutines(filters: RoutineFilters = {}): any {
    return useInfiniteQuery({
        ...
        queryFn: ({ pageParam, signal }) => fetchRoutines(filters, pageParam, 20, signal),
