...
async function fetchRoutineDay(id: string): Promise<RoutineDayWithData | undefined> {
...
// Search routine days
async function searchRoutineDays(term: string, limit = 10): Promise<RoutineDayWithRoutine[]> {
