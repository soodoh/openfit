...
async function fetchSessionsByDateRange(startDate: number, endDate: number): Promise<WorkoutSessionSummary[]> {
...
async function fetchCurrentSession(): Promise<WorkoutSessionWithData | undefined> {
...
async function fetchSession(id: string): Promise<WorkoutSessionWithData | undefined> {
...
export function useSessionsByDateRange(startDate: number, endDate: number): any {
    return useQuery({
