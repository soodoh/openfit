...
export function useAdminUsersPaginated(params: AdminPaginationParams) {
  return useQuery({
...
export function useAdminExercisesPaginated(params: AdminPaginationParams) {
  return useQuery({
...
export function useAdminMuscleGroups() {
  return useQuery({
...
export function useAdminRepetitionUnits() {
  return useQuery({
...
export function useAdminWeightUnits() {
  return useQuery({
