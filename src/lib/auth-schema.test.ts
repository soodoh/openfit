/* eslint-disable eslint(prefer-template), eslint-plugin-jest(no-conditional-expect), eslint-plugin-jest(no-conditional-in-test), eslint-plugin-jest(valid-expect), eslint-plugin-unicorn(filename-case) */
