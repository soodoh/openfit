...
export const queryKeys = {
  ...
  exercises: {
    ...
    search: (term: string, filters: Record<string, unknown> = {}) =>
      [...queryKeys.exercises.all, "search", term, filters] as const,
    similar: (params: Record<string, unknown>) =>
      [...queryKeys.exercises.all, "similar", params] as const,
  },
  ...
  sessions: {
    ...
    byDateRange: (startDate: number, endDate: number) =>
      [...queryKeys.sessions.all, "dateRange", startDate, endDate] as const,
  },
  ...
  dashboard: {
    ...
    recentSessions: () =>
      [...queryKeys.dashboard.all, "recentSessions"] as const,
  },
  ...
  admin: {
    ...
    userList: (params: { page: number; pageSize: number; search?: string }) =>
