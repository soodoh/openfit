...
export function DateTimePicker({ value, onChange, label, disabled, className, }: DateTimePickerProps): any {
    ...
    return (<div className={cn("flex flex-col gap-2", className)}>
      ...
      <Popover>
        <PopoverTrigger asChild>
          <Button type="button" variant="outline" disabled={disabled} className={cn("w-full justify-start text-left font-normal", !date && "text-muted-foreground")}>
