...
export const ResumeSessionButton = ({ session, }: {
    ...
    return (<Link to="/workout" className="group block w-full rounded-xl bg-linear-to-r from-primary to-primary/80 p-px shadow-lg hover:shadow-xl transition-all duration-300">
      <div className="flex items-center justify-between gap-4 rounded-[11px] bg-linear-to-r from-primary to-primary/90 px-5 py-4 text-primary-foreground">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            ...
            {totalSets > 0 && (<div className="flex items-center gap-2 mt-1">
        ...
        {/* Arrow */}
        <Button variant="secondary" size="sm" className="gap-1.5 bg-primary-foreground/20 hover:bg-primary-foreground/30 text-primary-foreground border-0">
          Continue
...
export default ResumeSessionButton;
