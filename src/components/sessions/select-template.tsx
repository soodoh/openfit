/* eslint-disable eslint(no-nested-ternary), eslint-plugin-import(prefer-default-export), eslint-plugin-jsx-a11y(role-has-required-aria-props), eslint-plugin-unicorn(filename-case), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types) */
