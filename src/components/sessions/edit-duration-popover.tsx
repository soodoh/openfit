/* eslint-disable eslint-plugin-import(prefer-default-export), eslint-plugin-react(button-has-type), eslint-plugin-unicorn(filename-case), eslint-plugin-unicorn(prefer-number-properties), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types) */
