/* eslint-disable eslint-plugin-import(prefer-default-export), eslint-plugin-jsx-a11y(click-events-have-key-events), eslint-plugin-jsx-a11y(no-static-element-interactions), eslint-plugin-unicorn(filename-case), typescript-eslint(explicit-module-boundary-types) */
...
export const SessionSummaryCard = ({
  ...
  return (
    <Link to={isActive ? "/workout" : "/logs"} className="group block">
      {cardContent}
    </Link>
  );
};
