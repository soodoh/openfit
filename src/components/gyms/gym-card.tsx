...
export function GymCard({ gym, isDefault = false, onEdit, onDelete, }: GymCardProps): any {
    const equipmentCount = gym.equipmentIds.length;
    return (<Card className="group flex flex-col overflow-hidden border-border/50 bg-card/50 backdrop-blur-xs shadow-xs hover:shadow-lg hover:border-border transition-all duration-300">
        ...
        <div className="relative flex items-start justify-between gap-3">
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              ...
              {isDefault && (<Badge variant="secondary" className="bg-accent/20 text-accent-foreground shrink-0">
