...
export function DeleteGymModal({ gym, isLastGym = false, onClose, }: DeleteGymModalProps): any {
    const open = gym !== null;
    ...
    const handleDelete = async () => {
        ...
        try {
            ...
            const message = caughtError instanceof Error ? caughtError.message : "Failed to delete gym";
    ...
    if (error) {
        bodyContent = (<div className="flex items-start gap-3 p-3 rounded-lg bg-red-100 dark:bg-red-950 text-red-700 dark:text-red-300">
        ...
        bodyContent = (<p className="text-sm text-muted-foreground">
    ...
    return (<Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-[400px]">
        ...
        <DialogFooter>
          ...
          {!error && !isLastGym && (<Button type="button" variant="destructive" onClick={handleDelete} disabled={isPending} className="min-w-[100px]">
              {isPending ? (<>
