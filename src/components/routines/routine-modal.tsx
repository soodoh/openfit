/* eslint-disable eslint(no-negated-condition), eslint-plugin-import(prefer-default-export), eslint-plugin-unicorn(consistent-function-scoping), eslint-plugin-unicorn(filename-case), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types) */
