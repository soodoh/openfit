/* eslint-disable eslint(complexity), eslint-plugin-import(prefer-default-export), eslint-plugin-react(no-array-index-key), eslint-plugin-unicorn(filename-case), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types) */
...
export const ExerciseDetailModal = ({
  ...
  const imageUrls: Array<string | null> = exercise?.imageUrls ?? [];
