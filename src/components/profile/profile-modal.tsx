/* eslint-disable eslint(no-nested-ternary), eslint(no-shadow), eslint-plugin-import(no-duplicates), eslint-plugin-import(prefer-default-export), eslint-plugin-jsx-a11y(no-autofocus), eslint-plugin-unicorn(filename-case), eslint-plugin-unicorn(no-nested-ternary), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types), typescript-eslint(no-use-before-define) */
