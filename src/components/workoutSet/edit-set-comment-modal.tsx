...
export const EditSetCommentModal = ({ open, onClose, setGroup, }: {
    open: boolean;
    onClose: () => void;
    ...
    return (<Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col gap-2">
          ...
          <Textarea id="comment" value={comment} onChange={(event) => setComment(event.target.value)} rows={4} placeholder="Add a comment..."/>
        </div>
        <DialogFooter>
...
export default EditSetCommentModal;
