/* eslint-disable eslint(no-shadow), eslint-plugin-import(prefer-default-export), eslint-plugin-unicorn(filename-case), eslint-plugin-unicorn(no-array-reduce), typescript-eslint(explicit-module-boundary-types), typescript-eslint(no-restricted-types) */
