        ...
        handlers: {
            ...
            POST: async ({ request }) => {
                ...
                try {
                    ...
                    const { setGroupId, exerciseId, type = "NORMAL", reps, repetitionUnitId, weight, weightUnitId, restTime, } = body;
                    if (!setGroupId || !exerciseId) {
                        return Response.json({ error: "setGroupId and exerciseId are required" }, { status: 400 });
                    }
                    ...
                    const maxOrder = existingSets.length > 0
