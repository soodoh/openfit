...
type LookupType = "equipment" | "categories" | "muscleGroups" | "repetitionUnits" | "weightUnits";
const tableMap = {
        ...
        handlers: {
            PATCH: async ({ request, params }) => {
                try {
                    ...
                    return Response.json({ error: "Failed to update lookup" }, { status: 500 });
                }
            },
            DELETE: async ({ request, params }) => {
                try {
                    ...
                    return Response.json({ error: "Failed to delete lookup" }, { status: 500 });
                }
            },
        },
    },
